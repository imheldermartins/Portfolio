...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      <div className="w-4/5 mx-auto flex flex-col items-center relative top-[20vh] md:flex-row md:items-end md:top-0">
        {/* Image - Profile */}
        <div className="
                w-[150px] 
                h-[150px] 
        ...
        <div className="w-full md:w-[calc(100%-200px)] p-3 flex flex-col md:flex-row justify-between items-center">
          <span>
            ...
            <h1 className="text-2xl md:text-4xl font-black leading-tight tracking-wide">Helder Martins</h1>
          </span>
